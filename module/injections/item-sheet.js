...
export function initItemSheetHooks() {
    Hooks.on("renderItemSheet5e", async (app, html, data) => {
        ...
        const stockTargetValue = foundry.utils.getProperty(app.object, "system.target.value");
        const targetValue = foundry.utils.getProperty(app.object, "flags.wire.override.target.value") || stockTargetValue;
        ...
        // Damage parts
        const parts = app.object.system.damage?.parts || [];
        const wireParts = app.object.flags.wire?.damageParts || [];
        ...
        // Checked ability
        const checkedAbility = app.object.flags.wire?.checkedAbility;
        ...
        if (app.object.system.scaling?.mode === "level") {
            const interval = app.object.flags.wire?.upcastInterval || "";
